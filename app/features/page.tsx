...
export const metadata: Metadata = {
  title: "Features",
  description:
    "See how ModeAlert detects new League of Legends, Valorant, and Fortnite events before they're officially announced, and emails you the moment something changes.",
}
...
const CORE_FEATURES = [
  ...
  },
  {
    ...
    description:
      "Track League of Legends, Valorant, and Fortnite from a single watchlist instead of checking three different launchers and Twitter accounts.",
    icon: Gamepad2,
